import { BadRequestException, Body, Controller, Get, Param, ParseArrayPipe, ParseFloatPipe, Patch, Post, Query, Request, SerializeOptions, UseGuards } from '@nestjs/common';
...
export class UsersController {
  ...
  async getNearbyProviders(
    ...
    return this.usersService.findNearbyProviders(latitude, longitude, searchRadius);
  }
